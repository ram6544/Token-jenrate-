...
# Import 𓍯𝙎𝙪𝙟𝙖𝙡⚝ configuration
try:
    from SUJAL_config import *
...
# ORG_CODES loaded from SUJAL_config.py (fallback defined above if config not found)
...
class RealTokenGenerator:
    ...
    def save_token_info(self, token, org_code, org_name, email, generation_time):
        ...
        try:
            ...
            with open('sujal.txt', 'a', encoding='utf-8') as f:
                f.write(f"\n--- Token Generated ---\n")
